...
@AttributeOverrides({ @AttributeOverride(name = "id", column = @Column(name = "ORDST_ID")),
...
@AssociationOverrides({ @AssociationOverride(name = "createdByUser", joinColumns = @JoinColumn(name = "ORDST_CREATED_BY_USER_ID")),
