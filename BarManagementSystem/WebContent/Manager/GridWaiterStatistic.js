		...
		.define(
				'MyDesktop.GridWaiterStatistic',
				{
					...
					init : function() {
						...
						this.currentStore = new Ext.data.JsonStore({
                        	autoLoad: true,
                            autoSync: true,
                            model: 'UserStatistic',
                            proxy: {
                                type: 'rest',
                                url: 'http://localhost:8080/BarManagementSystem/jaxrs/statistic/waiter',
                                reader: {
                                    type: 'json',
                                    root: 'data'
                                },
					...
					createWindow : function() {
						...
						if (!win) {
							win = desktop
									.createWindow({
										id : 'grid-waiterStatistic',
										title : '\u0421\u0442\u0430\u0442\u0438\u0441\u0442\u0438\u043A\u0430 \u0437\u0430 \u0441\u0435\u0440\u0432\u0438\u0442\u044C\u043E\u0440\u0438 \u043F\u043E \u0431\u0440\u043E\u0439 \u043D\u0430\u043F\u0440\u0430\u0432\u0435\u043D\u0438 \u043F\u043E\u0440\u044A\u0447\u043A\u0438',
										width : 840,
										height : 580,
										iconCls : 'icon-mychart',
										animCollapse : false,
											...
											series : [ {
												...
												tips: {
									                  ...
									                  renderer: function(storeItem, item) {
									                    ...
									                    var total = 0;
									                    Ext.getCmp( 'mywaiterchart' ).getStore().each(function(rec) {
									                        total += rec.get('data');
									                    });
